...
pub enum QueryParserFeatureFlag {
     ...
     */
    FLAG_DEFAULT =
        Self::FLAG_PHRASE as i32 | Self::FLAG_BOOLEAN as i32 | Self::FLAG_LOVEHATE as i32,
}
...
pub(crate) mod ffi {
    ...
    unsafe extern "C++" {
        ...
        pub(crate) fn new_database_with_path(
            path: &str,
            db_type: i8,
            err: &mut i8,
        ) -> UniquePtr<Database>;
        ...
        pub(crate) fn new_writable_database_with_path(
            path: &str,
            action: i8,
            db_type: i8,
            err: &mut i8,
        ) -> UniquePtr<WritableDatabase>;
        ...
        pub(crate) fn index_text_with_prefix(
            tg: Pin<&mut TermGenerator>,
            data: &str,
            prefix: &str,
            err: &mut i8,
        ...
        pub(crate) fn index_long(
            tg: Pin<&mut TermGenerator>,
            data: i64,
            prefix: &str,
            err: &mut i8,
        );
        pub(crate) fn index_float(
            tg: Pin<&mut TermGenerator>,
            data: f32,
            prefix: &str,
            err: &mut i8,
        );
        pub(crate) fn index_double(
            tg: Pin<&mut TermGenerator>,
            data: f64,
            prefix: &str,
            err: &mut i8,
        ...
        pub(crate) fn mset_iterator_get_document(
            iter: Pin<&mut MSetIterator>,
            err: &mut i8,
        ) -> UniquePtr<Document>;
        pub(crate) fn mset_iterator_eq(
            iter: Pin<&mut MSetIterator>,
        ...
        pub(crate) fn set_sort_by_key(
            en: Pin<&mut Enquire>,
            sorter: Pin<&mut MultiValueKeyMaker>,
            reverse: bool,
            err: &mut i8,
        );
        pub(crate) fn add_matchspy_value_count(
            en: Pin<&mut Enquire>,
            vcms: Pin<&mut ValueCountMatchSpy>,
            err: &mut i8,
        );

        pub(crate) fn new_query_parser(err: &mut i8) -> UniquePtr<QueryParser>;
        pub(crate) fn set_max_wildcard_expansion(
            qp: Pin<&mut QueryParser>,
            limit: i32,
            err: &mut i8,
        );
        pub(crate) fn set_stemmer_to_qp(
            qp: Pin<&mut QueryParser>,
            stem: Pin<&mut Stem>,
            err: &mut i8,
        );
        ...
        pub(crate) fn add_boolean_prefix(
            qp: Pin<&mut QueryParser>,
            field: &str,
            prefix: &str,
            err: &mut i8,
        );
        pub(crate) fn add_rangeprocessor(
            qp: Pin<&mut QueryParser>,
            range_proc: Pin<&mut RangeProcessor>,
            err: &mut i8,
        );
        pub(crate) fn add_number_rangeprocessor(
            qp: Pin<&mut QueryParser>,
        ...
        pub(crate) fn parse_query_with_prefix(
            qp: Pin<&mut QueryParser>,
            query_string: &str,
            flags: i32,
            prefix: &str,
        ...
        pub(crate) fn add_right_query(
            this_q: Pin<&mut Query>,
            op: i32,
            q: Pin<&mut Query>,
            err: &mut i8,
        ) -> UniquePtr<Query>;
        pub(crate) fn new_query_double_with_prefix(
            prefix: &str,
            d: f64,
            err: &mut i8,
        ) -> UniquePtr<Query>;
        ...
        pub(crate) fn add_value_to_multi_value_key_maker(
        ...
        pub(crate) fn new_value_count_match_spy(
            slot: u32,
            err: &mut i8,
        ) -> UniquePtr<ValueCountMatchSpy>;
        pub(crate) fn new_range_processor(
            slot: u32,
            prefix: &str,
            flags: i32,
            err: &mut i8,
        ) -> UniquePtr<RangeProcessor>;
        pub(crate) fn new_number_range_processor(
            slot: u32,
            prefix: &str,
            flags: i32,
            err: &mut i8,
        ) -> UniquePtr<NumberRangeProcessor>;

        pub(crate) fn value_count_matchspy_values_begin(
            vcms: Pin<&mut ValueCountMatchSpy>,
            err: &mut i8,
        ) -> UniquePtr<TermIterator>;
        pub(crate) fn value_count_matchspy_values_end(
            vcms: Pin<&mut ValueCountMatchSpy>,
            err: &mut i8,
        ) -> UniquePtr<TermIterator>;
        pub(crate) fn value_count_matchspy_get_total(
            vcms: Pin<&mut ValueCountMatchSpy>,
            err: &mut i8,
        ) -> i32;

        pub(crate) fn term_iterator_get_termfreq_value<'a>(
            titer: Pin<&'a mut TermIterator>,
            err: &'a mut i8,
        ) -> &'a CxxString;
        pub(crate) fn term_iterator_get_termfreq_freq(
            titer: Pin<&mut TermIterator>,
            err: &mut i8,
        ) -> i32;
        pub(crate) fn term_iterator_eq(
            titer: Pin<&mut TermIterator>,
...
impl Query {
    ...
    pub fn add_right(&mut self, op: XapianOp, q: &mut Query) -> Result<Self, XError> {
        ...
        unsafe {
            let mut err = 0;
            let obj =
                ffi::add_right_query(self.cxxp.pin_mut(), op as i32, q.cxxp.pin_mut(), &mut err);
...
impl QueryParser {
    ...
    pub fn add_number_rangeprocessor(
        &mut self,
        range_proc: &mut NumberRangeProcessor,
    ) -> Result<(), XError> {
        unsafe {
            let mut err = 0;
            ffi::add_number_rangeprocessor(
                self.cxxp.pin_mut(),
                range_proc.cxxp.pin_mut(),
                &mut err,
            );
    ...
    pub fn parse_query_with_prefix(
        ...
        unsafe {
            let mut err = 0;
            let obj =
                ffi::parse_query_with_prefix(self.cxxp.pin_mut(), query, flags, prefix, &mut err);
            if err == 0 {
                Ok(Query { cxxp: obj })
            } else {
                Err(XError::Xapian(err))
...
impl MSetIterator {
    ...
    pub fn get_document(&mut self) -> Result<Document, XError> {
        ...
        unsafe {
            let mut err = 0;
            let mut doc = ffi::mset_iterator_get_document(self.cxxp.pin_mut(), &mut err);
...
impl Enquire {
    ...
    pub fn set_sort_by_key(
        &mut self,
        mut sorter: MultiValueKeyMaker,
        reverse: bool,
    ) -> Result<(), XError> {
        #[allow(unused_unsafe)]
        unsafe {
    ...
    pub fn add_matchspy_value_count(
        &mut self,
        vcms: &mut ValueCountMatchSpy,
    ) -> Result<(), XError> {
        #[allow(unused_unsafe)]
        unsafe {
            let mut err = 0;
